...
class Prefs_model extends CI_Model {
    ...
    public function user_info_login($id)
    {
        ...
        $data['nip']		= $user->nip;
        $data['foto']		= $this->pegawai_model->getImage($user->nip);
        $data['prilaku']	= $this->staff_model->penilaianPrilakuHarian();
        $data['kinerja']	= $this->staff_model->penilaianKinerjaHarian();
        $data['absensi']	= $this->staff_model->penilaianAbsensiHarian();
