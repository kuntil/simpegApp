	...
	public function __construct()
	{
        ...
        else
        {
        	if($this->ion_auth->is_admin()){
        		...
        		/* Load */
        		$this->load->config('member/dp_config');
        		$this->load->library('member/page_title');
        		$this->load->library('member/breadcrumbs');
        		$this->load->model('admin/core_model');
        		$this->load->helper('menu');
        		$this->lang->load(array('member/main_header', 'member/main_sidebar', 'member/footer', 'member/actions'));
        		
        		/* Load library function  */
        		$this->breadcrumbs->unshift(0, $this->lang->line('menu_dashboard'), 'member/dashboard');
