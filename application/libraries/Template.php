...
class Template {
	...
	public function member_render($content, $data = NULL){
		...
		else
		{
			...
			$this->template['main_header']     = $this->CI->load->view('member/_templates/main_header', $data, TRUE);
			$this->template['main_sidebar']    = $this->CI->load->view('member/_templates/main_sidebar', $data, TRUE);
			$this->template['content']         = $this->CI->load->view($content, $data, TRUE);
			$this->template['control_sidebar'] = $this->CI->load->view('member/_templates/control_sidebar', $data, TRUE);
	...
	public function info_render($content, $data = NULL){
		if ( ! $content)
		{
			return NULL;
		}
		...
		{
			$this->template['header']          = $this->CI->load->view('info/_templates/header', $data, TRUE);
			$this->template['main_header']     = $this->CI->load->view('info/_templates/main_header', $data, TRUE);
			$this->template['main_sidebar']    = $this->CI->load->view('info/_templates/main_sidebar', $data, TRUE);
			$this->template['content']         = $this->CI->load->view($content, $data, TRUE);
			$this->template['control_sidebar'] = $this->CI->load->view('info/_templates/control_sidebar', $data, TRUE);
			$this->template['footer']          = $this->CI->load->view('info/_templates/footer', $data, TRUE);
	
			return $this->CI->load->view('info/_templates/template', $this->template);
		}
	}
