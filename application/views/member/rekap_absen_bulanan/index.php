	...
	<div class="panel-body">
		<div class="dataTable_wrapper">
			...
			?>
		        ...
		        <td ><center>
		        <a href="<?php echo base_url('member/staff/prilaku/'.$row->nip.'/'.$row->kd_skpd.'/'.$row->kd_position) ?>" onclick="return confirm('Anda Yakin ?');"><button class="btn btn-success btn-xs" title="Penilaian Pribadi"><i class="fa fa-recycle"></i></button></a>
		        &nbsp;
				<a href="<?php echo base_url('member/staff/prilaku/'.$row->nip.'/'.$row->kd_skpd.'/'.$row->kd_position) ?>" onclick="return confirm('Anda Yakin ?');"><button class="btn btn-danger btn-xs" title="Penilaian Pribadi"><i class="fa fa-user"></i></button></a>
				</center></td>
				</tr>
	        <?php 
	        	$i++;
