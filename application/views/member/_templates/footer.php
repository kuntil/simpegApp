...
?>
            ...
            <footer class="main-footer">
                ...
                <strong><?php echo lang('footer_copyright'); ?> &copy; 2014-<?php echo date('Y'); ?> <a href="http://www.technos-studio.com" target="_blank">TechnosStudio</a> &amp;.</strong> <?php echo lang('footer_all_rights_reserved'); ?>.
            </footer>
        </div>
