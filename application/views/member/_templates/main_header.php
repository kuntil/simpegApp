...
?>
            <header class="main-header">
                <a href="<?php echo site_url('admin/dashboard'); ?>" class="logo">
                    ...
                    <span class="logo-lg"><b>Kartu Kinerja ASN</b></span>
                </a>
...
<?php if ($admin_prefs['user_menu'] == TRUE): ?>
                            ...
                            <li class="dropdown user user-menu">
                                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                                    <img src="<?php echo base_url('/upload/pegawai/'.$user_login['foto']); ?>" class="user-image" alt="User Image">
                                    <span class="hidden-xs"><?php echo $user_login['firstname']; ?></span>
                                </a>
                                <ul class="dropdown-menu">
                                    <li class="user-header">
                                        <img src="<?php echo base_url('/upload/pegawai/'.$user_login['foto']); ?>" class="img-circle" alt="User Image">
