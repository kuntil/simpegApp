	...
	<div class="row">
		<div class="col-lg-12">
			...
			if($this->uri->segment(3)=="add"){
				echo form_open('setup/riwayat_hukuman/add');
			}else if($this->uri->segment(3)=="modify"){
				echo form_open('setup/riwayat_hukuman/modify/'.$this->uri->segment(4).'/'.$this->uri->segment(5));
			}else{
				echo form_open('setup/riwayat_hukuman/detail');
			}
			?>
				<div class="box-body">
					<div class="col-lg-6">
					...
					<div class="col-lg-6">
						...
						<div class="form-group">
							<label >Uraian Hukuman</label>
							<?php echo form_textarea($uraian_hukum)?>
						</div>
					</div>
					<div class="col-lg-12">
					</div>
				...
				<div class="box-footer">
					...
					<?php echo anchor('setup/riwayat_hukuman/index', 
