...
<div class="panel panel-primary">
	<div class="panel-heading">
		<h3>
			<i class="fa fa-user"></i> Riwayat Jabatan
		</h3>
	</div>
	<!-- /.panel-heading -->
	<div class="panel-body">
		...
		<div class="col-sm-12">
			<div class="row">
			<?php echo form_open("setup/riwayat_jabatan/index",array('method'=>'POST'));?>
					<div class="box-body">
					<div class="col-sm-3">
	...
	<div class="panel-body">
		<div class="dataTable_wrapper">
			...
			<tr>
				...
				<th class="col-md-1">Tgl. ditetapkan</th>
			...
			?>
		        ...
		        <td class="col-md-1"><?php echo $row->nama_skpd?></td>
		        <td class="col-md-1"><?php echo $row->nama_position?></td>
		        <td class="col-md-1"><?php echo $row->no_sk?></td>
		        <td class="col-md-1"><?php echo $row->tgl_sk?></td>
		        <td class="col-md-1"><?php echo $row->valid_from?></td>
		        <td ><center>
		        <a href="<?php echo base_url('setup/riwayat_jabatan/modify/'.$row->nip.'/'.$row->seq_no) ?>"><button class="btn btn-warning btn-xs" title="Edit"><i class="fa fa-edit"></i></button></a>
		        &nbsp;
		        <a href="<?php echo base_url('setup/riwayat_jabatan/remove/'.$row->nip.'/'.$row->seq_no) ?>" onclick="return confirm('Anda Yakin ?');"><button class="btn btn-danger btn-xs" title="Delete"><i class="fa fa-remove"></i></button></a>
				</center></td>
				</tr>
	        <?php $i++; 
				}
		...
		<div class=row>
			<div class="col-md-6 col-sm-4 col-xs-4">
				<div class="btn-group">
				<?php echo anchor('setup/riwayat_jabatan/add', 
				...
				&nbsp;
				<?php echo anchor('setup/riwayat_jabatan', 
